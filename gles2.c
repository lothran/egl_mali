...
static void _pre_call_gles2_callback_default(const char *name,
...
static void _post_call_gles2_callback_default(void *ret, const char *name,
                                              GLADapiproc apiproc, int len_args,
                                              ...) {
  GLenum error_code;
...
static GLADprecallback _pre_call_gles2_callback =
    _pre_call_gles2_callback_default;
void gladSetGLES2PreCallback(GLADprecallback cb) {
  _pre_call_gles2_callback = cb;
}
static GLADpostcallback _post_call_gles2_callback =
    _post_call_gles2_callback_default;
...
static void GLAD_API_PTR glad_debug_impl_glActiveTexture(GLenum texture) {
  _pre_call_gles2_callback("glActiveTexture", (GLADapiproc)glad_glActiveTexture,
                           1, texture);
  glad_glActiveTexture(texture);
  _post_call_gles2_callback(NULL, "glActiveTexture",
...
static void GLAD_API_PTR glad_debug_impl_glAttachShader(GLuint program,
                                                        GLuint shader) {
  _pre_call_gles2_callback("glAttachShader", (GLADapiproc)glad_glAttachShader,
                           2, program, shader);
  glad_glAttachShader(program, shader);
  _post_call_gles2_callback(NULL, "glAttachShader",
                            (GLADapiproc)glad_glAttachShader, 2, program,
                            shader);
}
...
static void GLAD_API_PTR glad_debug_impl_glBindAttribLocation(
  ...
  _pre_call_gles2_callback("glBindAttribLocation",
                           (GLADapiproc)glad_glBindAttribLocation, 3, program,
                           index, name);
  glad_glBindAttribLocation(program, index, name);
  _post_call_gles2_callback(NULL, "glBindAttribLocation",
                            (GLADapiproc)glad_glBindAttribLocation, 3, program,
                            index, name);
}
...
static void GLAD_API_PTR glad_debug_impl_glBindBuffer(GLenum target,
                                                      GLuint buffer) {
  _pre_call_gles2_callback("glBindBuffer", (GLADapiproc)glad_glBindBuffer, 2,
                           target, buffer);
  glad_glBindBuffer(target, buffer);
  _post_call_gles2_callback(NULL, "glBindBuffer",
                            (GLADapiproc)glad_glBindBuffer, 2, target, buffer);
}
...
static void GLAD_API_PTR glad_debug_impl_glBindFramebuffer(GLenum target,
                                                           GLuint framebuffer) {
  _pre_call_gles2_callback("glBindFramebuffer",
                           (GLADapiproc)glad_glBindFramebuffer, 2, target,
                           framebuffer);
  glad_glBindFramebuffer(target, framebuffer);
  _post_call_gles2_callback(NULL, "glBindFramebuffer",
                            (GLADapiproc)glad_glBindFramebuffer, 2, target,
                            framebuffer);
}
...
glad_debug_impl_glBindRenderbuffer(GLenum target, GLuint renderbuffer) {
  _pre_call_gles2_callback("glBindRenderbuffer",
                           (GLADapiproc)glad_glBindRenderbuffer, 2, target,
                           renderbuffer);
  glad_glBindRenderbuffer(target, renderbuffer);
  _post_call_gles2_callback(NULL, "glBindRenderbuffer",
                            (GLADapiproc)glad_glBindRenderbuffer, 2, target,
                            renderbuffer);
}
...
static void GLAD_API_PTR glad_debug_impl_glBindTexture(GLenum target,
                                                       GLuint texture) {
  _pre_call_gles2_callback("glBindTexture", (GLADapiproc)glad_glBindTexture, 2,
                           target, texture);
  glad_glBindTexture(target, texture);
  _post_call_gles2_callback(NULL, "glBindTexture",
                            (GLADapiproc)glad_glBindTexture, 2, target,
                            texture);
}
...
static void GLAD_API_PTR glad_debug_impl_glBlendColor(GLfloat red,
                                                      ...
                                                      GLfloat blue,
                                                      GLfloat alpha) {
  _pre_call_gles2_callback("glBlendColor", (GLADapiproc)glad_glBlendColor, 4,
                           red, green, blue, alpha);
  glad_glBlendColor(red, green, blue, alpha);
  _post_call_gles2_callback(NULL, "glBlendColor",
                            (GLADapiproc)glad_glBlendColor, 4, red, green, blue,
                            alpha);
}
...
static void GLAD_API_PTR glad_debug_impl_glBlendEquation(GLenum mode) {
  _pre_call_gles2_callback("glBlendEquation", (GLADapiproc)glad_glBlendEquation,
                           1, mode);
  glad_glBlendEquation(mode);
  _post_call_gles2_callback(NULL, "glBlendEquation",
...
glad_debug_impl_glBlendEquationSeparate(GLenum modeRGB, GLenum modeAlpha) {
  _pre_call_gles2_callback("glBlendEquationSeparate",
                           (GLADapiproc)glad_glBlendEquationSeparate, 2,
                           modeRGB, modeAlpha);
  glad_glBlendEquationSeparate(modeRGB, modeAlpha);
  _post_call_gles2_callback(NULL, "glBlendEquationSeparate",
                            (GLADapiproc)glad_glBlendEquationSeparate, 2,
                            modeRGB, modeAlpha);
}
...
static void GLAD_API_PTR glad_debug_impl_glBlendFunc(GLenum sfactor,
                                                     GLenum dfactor) {
  _pre_call_gles2_callback("glBlendFunc", (GLADapiproc)glad_glBlendFunc, 2,
                           sfactor, dfactor);
  glad_glBlendFunc(sfactor, dfactor);
  _post_call_gles2_callback(NULL, "glBlendFunc", (GLADapiproc)glad_glBlendFunc,
                            2, sfactor, dfactor);
}
...
glad_debug_impl_glBlendFuncSeparate(GLenum sfactorRGB, GLenum dfactorRGB,
  ...
  _pre_call_gles2_callback("glBlendFuncSeparate",
  ...
  _post_call_gles2_callback(NULL, "glBlendFuncSeparate",
                            (GLADapiproc)glad_glBlendFuncSeparate, 4,
...
static void GLAD_API_PTR glad_debug_impl_glBufferData(GLenum target,
                                                      ...
                                                      const void *data,
                                                      GLenum usage) {
  _pre_call_gles2_callback("glBufferData", (GLADapiproc)glad_glBufferData, 4,
                           target, size, data, usage);
  glad_glBufferData(target, size, data, usage);
  _post_call_gles2_callback(NULL, "glBufferData",
                            (GLADapiproc)glad_glBufferData, 4, target, size,
                            data, usage);
}
...
static void GLAD_API_PTR glad_debug_impl_glBufferSubData(GLenum target,
                                                         ...
                                                         GLsizeiptr size,
                                                         const void *data) {
  _pre_call_gles2_callback("glBufferSubData", (GLADapiproc)glad_glBufferSubData,
                           4, target, offset, size, data);
  glad_glBufferSubData(target, offset, size, data);
  _post_call_gles2_callback(NULL, "glBufferSubData",
                            (GLADapiproc)glad_glBufferSubData, 4, target,
                            offset, size, data);
}
...
glad_debug_impl_glCheckFramebufferStatus(GLenum target) {
  GLenum ret;
  _pre_call_gles2_callback("glCheckFramebufferStatus",
                           (GLADapiproc)glad_glCheckFramebufferStatus, 1,
                           target);
  ret = glad_glCheckFramebufferStatus(target);
  _post_call_gles2_callback((void *)&ret, "glCheckFramebufferStatus",
                            (GLADapiproc)glad_glCheckFramebufferStatus, 1,
                            target);
  return ret;
}
...
static void GLAD_API_PTR glad_debug_impl_glClear(GLbitfield mask) {
  ...
  glad_glClear(mask);
  _post_call_gles2_callback(NULL, "glClear", (GLADapiproc)glad_glClear, 1,
                            mask);
}
...
static void GLAD_API_PTR glad_debug_impl_glClearColor(GLfloat red,
                                                      ...
                                                      GLfloat blue,
                                                      GLfloat alpha) {
  _pre_call_gles2_callback("glClearColor", (GLADapiproc)glad_glClearColor, 4,
                           red, green, blue, alpha);
  glad_glClearColor(red, green, blue, alpha);
  _post_call_gles2_callback(NULL, "glClearColor",
                            (GLADapiproc)glad_glClearColor, 4, red, green, blue,
                            alpha);
}
...
static void GLAD_API_PTR glad_debug_impl_glClearDepthf(GLfloat d) {
  _pre_call_gles2_callback("glClearDepthf", (GLADapiproc)glad_glClearDepthf, 1,
                           d);
  glad_glClearDepthf(d);
  _post_call_gles2_callback(NULL, "glClearDepthf",
                            (GLADapiproc)glad_glClearDepthf, 1, d);
}
...
static void GLAD_API_PTR glad_debug_impl_glClearStencil(GLint s) {
  _pre_call_gles2_callback("glClearStencil", (GLADapiproc)glad_glClearStencil,
                           1, s);
  glad_glClearStencil(s);
  _post_call_gles2_callback(NULL, "glClearStencil",
...
static void GLAD_API_PTR glad_debug_impl_glColorMask(GLboolean red,
                                                     ...
                                                     GLboolean blue,
                                                     GLboolean alpha) {
  _pre_call_gles2_callback("glColorMask", (GLADapiproc)glad_glColorMask, 4, red,
                           green, blue, alpha);
  glad_glColorMask(red, green, blue, alpha);
  _post_call_gles2_callback(NULL, "glColorMask", (GLADapiproc)glad_glColorMask,
...
static void GLAD_API_PTR glad_debug_impl_glCompileShader(GLuint shader) {
  _pre_call_gles2_callback("glCompileShader", (GLADapiproc)glad_glCompileShader,
                           1, shader);
  glad_glCompileShader(shader);
  _post_call_gles2_callback(NULL, "glCompileShader",
...
static void GLAD_API_PTR glad_debug_impl_glCompressedTexSubImage2D(
  ...
  _pre_call_gles2_callback("glCompressedTexSubImage2D",
                           (GLADapiproc)glad_glCompressedTexSubImage2D, 9,
                           target, level, xoffset, yoffset, width, height,
                           format, imageSize, data);
  glad_glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height,
                                 format, imageSize, data);
  _post_call_gles2_callback(NULL, "glCompressedTexSubImage2D",
                            (GLADapiproc)glad_glCompressedTexSubImage2D, 9,
                            target, level, xoffset, yoffset, width, height,
                            format, imageSize, data);
}
...
static void GLAD_API_PTR glad_debug_impl_glCopyTexImage2D(
  ...
  _pre_call_gles2_callback("glCopyTexImage2D",
  ...
  glad_glCopyTexImage2D(target, level, internalformat, x, y, width, height,
                        border);
  _post_call_gles2_callback(NULL, "glCopyTexImage2D",
                            (GLADapiproc)glad_glCopyTexImage2D, 8, target,
...
static void GLAD_API_PTR glad_debug_impl_glCopyTexSubImage2D(
  ...
  _pre_call_gles2_callback("glCopyTexSubImage2D",
  ...
  glad_glCopyTexSubImage2D(target, level, xoffset, yoffset, x, y, width,
                           height);
  _post_call_gles2_callback(NULL, "glCopyTexSubImage2D",
                            (GLADapiproc)glad_glCopyTexSubImage2D, 8, target,
                            level, xoffset, yoffset, x, y, width, height);
}
...
static GLuint GLAD_API_PTR glad_debug_impl_glCreateProgram(void) {
  GLuint ret;
  _pre_call_gles2_callback("glCreateProgram", (GLADapiproc)glad_glCreateProgram,
                           0);
  ret = glad_glCreateProgram();
  _post_call_gles2_callback((void *)&ret, "glCreateProgram",
...
static GLuint GLAD_API_PTR glad_debug_impl_glCreateShader(GLenum type) {
  GLuint ret;
  _pre_call_gles2_callback("glCreateShader", (GLADapiproc)glad_glCreateShader,
                           1, type);
  ret = glad_glCreateShader(type);
  _post_call_gles2_callback((void *)&ret, "glCreateShader",
...
static void GLAD_API_PTR glad_debug_impl_glCullFace(GLenum mode) {
  ...
  _post_call_gles2_callback(NULL, "glCullFace", (GLADapiproc)glad_glCullFace, 1,
                            mode);
}
...
glad_debug_impl_glDeleteBuffers(GLsizei n, const GLuint *buffers) {
  _pre_call_gles2_callback("glDeleteBuffers", (GLADapiproc)glad_glDeleteBuffers,
                           2, n, buffers);
  glad_glDeleteBuffers(n, buffers);
  _post_call_gles2_callback(NULL, "glDeleteBuffers",
...
glad_debug_impl_glDeleteFramebuffers(GLsizei n, const GLuint *framebuffers) {
  _pre_call_gles2_callback("glDeleteFramebuffers",
                           (GLADapiproc)glad_glDeleteFramebuffers, 2, n,
                           framebuffers);
  glad_glDeleteFramebuffers(n, framebuffers);
  _post_call_gles2_callback(NULL, "glDeleteFramebuffers",
                            (GLADapiproc)glad_glDeleteFramebuffers, 2, n,
                            framebuffers);
}
...
static void GLAD_API_PTR glad_debug_impl_glDeleteProgram(GLuint program) {
  _pre_call_gles2_callback("glDeleteProgram", (GLADapiproc)glad_glDeleteProgram,
                           1, program);
  glad_glDeleteProgram(program);
  _post_call_gles2_callback(NULL, "glDeleteProgram",
...
glad_debug_impl_glDeleteRenderbuffers(GLsizei n, const GLuint *renderbuffers) {
  _pre_call_gles2_callback("glDeleteRenderbuffers",
                           (GLADapiproc)glad_glDeleteRenderbuffers, 2, n,
                           renderbuffers);
  glad_glDeleteRenderbuffers(n, renderbuffers);
  _post_call_gles2_callback(NULL, "glDeleteRenderbuffers",
                            (GLADapiproc)glad_glDeleteRenderbuffers, 2, n,
                            renderbuffers);
}
...
static void GLAD_API_PTR glad_debug_impl_glDeleteShader(GLuint shader) {
  _pre_call_gles2_callback("glDeleteShader", (GLADapiproc)glad_glDeleteShader,
                           1, shader);
  glad_glDeleteShader(shader);
  _post_call_gles2_callback(NULL, "glDeleteShader",
...
glad_debug_impl_glDeleteTextures(GLsizei n, const GLuint *textures) {
  _pre_call_gles2_callback("glDeleteTextures",
                           (GLADapiproc)glad_glDeleteTextures, 2, n, textures);
  glad_glDeleteTextures(n, textures);
  _post_call_gles2_callback(NULL, "glDeleteTextures",
                            (GLADapiproc)glad_glDeleteTextures, 2, n, textures);
}
...
static void GLAD_API_PTR glad_debug_impl_glDepthFunc(GLenum func) {
  _pre_call_gles2_callback("glDepthFunc", (GLADapiproc)glad_glDepthFunc, 1,
                           func);
  glad_glDepthFunc(func);
  _post_call_gles2_callback(NULL, "glDepthFunc", (GLADapiproc)glad_glDepthFunc,
                            1, func);
}
...
static void GLAD_API_PTR glad_debug_impl_glDepthMask(GLboolean flag) {
  _pre_call_gles2_callback("glDepthMask", (GLADapiproc)glad_glDepthMask, 1,
                           flag);
  glad_glDepthMask(flag);
  _post_call_gles2_callback(NULL, "glDepthMask", (GLADapiproc)glad_glDepthMask,
                            1, flag);
}
...
static void GLAD_API_PTR glad_debug_impl_glDepthRangef(GLfloat n, GLfloat f) {
  _pre_call_gles2_callback("glDepthRangef", (GLADapiproc)glad_glDepthRangef, 2,
                           n, f);
  glad_glDepthRangef(n, f);
  _post_call_gles2_callback(NULL, "glDepthRangef",
                            (GLADapiproc)glad_glDepthRangef, 2, n, f);
}
...
static void GLAD_API_PTR glad_debug_impl_glDetachShader(GLuint program,
                                                        GLuint shader) {
  _pre_call_gles2_callback("glDetachShader", (GLADapiproc)glad_glDetachShader,
                           2, program, shader);
  glad_glDetachShader(program, shader);
  _post_call_gles2_callback(NULL, "glDetachShader",
                            (GLADapiproc)glad_glDetachShader, 2, program,
                            shader);
}
...
static void GLAD_API_PTR glad_debug_impl_glDisable(GLenum cap) {
  ...
  glad_glDisable(cap);
  _post_call_gles2_callback(NULL, "glDisable", (GLADapiproc)glad_glDisable, 1,
                            cap);
}
...
glad_debug_impl_glDisableVertexAttribArray(GLuint index) {
  _pre_call_gles2_callback("glDisableVertexAttribArray",
                           (GLADapiproc)glad_glDisableVertexAttribArray, 1,
                           index);
  glad_glDisableVertexAttribArray(index);
  _post_call_gles2_callback(NULL, "glDisableVertexAttribArray",
                            (GLADapiproc)glad_glDisableVertexAttribArray, 1,
                            index);
}
...
static void GLAD_API_PTR glad_debug_impl_glDrawArrays(GLenum mode, GLint first,
                                                      GLsizei count) {
  _pre_call_gles2_callback("glDrawArrays", (GLADapiproc)glad_glDrawArrays, 3,
                           mode, first, count);
  glad_glDrawArrays(mode, first, count);
  _post_call_gles2_callback(NULL, "glDrawArrays",
                            (GLADapiproc)glad_glDrawArrays, 3, mode, first,
                            count);
}
...
static void GLAD_API_PTR glad_debug_impl_glDrawElements(GLenum mode,
                                                        ...
                                                        GLenum type,
                                                        const void *indices) {
  _pre_call_gles2_callback("glDrawElements", (GLADapiproc)glad_glDrawElements,
                           4, mode, count, type, indices);
  glad_glDrawElements(mode, count, type, indices);
  _post_call_gles2_callback(NULL, "glDrawElements",
                            (GLADapiproc)glad_glDrawElements, 4, mode, count,
                            type, indices);
}
...
static void GLAD_API_PTR glad_debug_impl_glEnable(GLenum cap) {
  ...
  glad_glEnable(cap);
  _post_call_gles2_callback(NULL, "glEnable", (GLADapiproc)glad_glEnable, 1,
                            cap);
}
...
glad_debug_impl_glEnableVertexAttribArray(GLuint index) {
  _pre_call_gles2_callback("glEnableVertexAttribArray",
                           (GLADapiproc)glad_glEnableVertexAttribArray, 1,
                           index);
  glad_glEnableVertexAttribArray(index);
  _post_call_gles2_callback(NULL, "glEnableVertexAttribArray",
                            (GLADapiproc)glad_glEnableVertexAttribArray, 1,
                            index);
}
...
static void GLAD_API_PTR glad_debug_impl_glFramebufferRenderbuffer(
    ...
    GLuint renderbuffer) {
  _pre_call_gles2_callback(
      "glFramebufferRenderbuffer", (GLADapiproc)glad_glFramebufferRenderbuffer,
      4, target, attachment, renderbuffertarget, renderbuffer);
  glad_glFramebufferRenderbuffer(target, attachment, renderbuffertarget,
                                 renderbuffer);
  _post_call_gles2_callback(NULL, "glFramebufferRenderbuffer",
                            (GLADapiproc)glad_glFramebufferRenderbuffer, 4,
...
static void GLAD_API_PTR glad_debug_impl_glFramebufferTexture2D(
    ...
    GLint level) {
  _pre_call_gles2_callback("glFramebufferTexture2D",
  ...
  _post_call_gles2_callback(NULL, "glFramebufferTexture2D",
                            (GLADapiproc)glad_glFramebufferTexture2D, 5, target,
                            attachment, textarget, texture, level);
}
...
static void GLAD_API_PTR glad_debug_impl_glFrontFace(GLenum mode) {
  _pre_call_gles2_callback("glFrontFace", (GLADapiproc)glad_glFrontFace, 1,
                           mode);
  glad_glFrontFace(mode);
  _post_call_gles2_callback(NULL, "glFrontFace", (GLADapiproc)glad_glFrontFace,
                            1, mode);
}
...
static void GLAD_API_PTR glad_debug_impl_glGenBuffers(GLsizei n,
                                                      GLuint *buffers) {
  _pre_call_gles2_callback("glGenBuffers", (GLADapiproc)glad_glGenBuffers, 2, n,
                           buffers);
  glad_glGenBuffers(n, buffers);
  _post_call_gles2_callback(NULL, "glGenBuffers",
                            (GLADapiproc)glad_glGenBuffers, 2, n, buffers);
}
...
glad_debug_impl_glGenFramebuffers(GLsizei n, GLuint *framebuffers) {
  _pre_call_gles2_callback("glGenFramebuffers",
                           (GLADapiproc)glad_glGenFramebuffers, 2, n,
                           framebuffers);
  glad_glGenFramebuffers(n, framebuffers);
  _post_call_gles2_callback(NULL, "glGenFramebuffers",
                            (GLADapiproc)glad_glGenFramebuffers, 2, n,
                            framebuffers);
}
...
glad_debug_impl_glGenRenderbuffers(GLsizei n, GLuint *renderbuffers) {
  _pre_call_gles2_callback("glGenRenderbuffers",
                           (GLADapiproc)glad_glGenRenderbuffers, 2, n,
                           renderbuffers);
  glad_glGenRenderbuffers(n, renderbuffers);
  _post_call_gles2_callback(NULL, "glGenRenderbuffers",
                            (GLADapiproc)glad_glGenRenderbuffers, 2, n,
                            renderbuffers);
}
...
static void GLAD_API_PTR glad_debug_impl_glGenTextures(GLsizei n,
                                                       GLuint *textures) {
  _pre_call_gles2_callback("glGenTextures", (GLADapiproc)glad_glGenTextures, 2,
                           n, textures);
  glad_glGenTextures(n, textures);
  _post_call_gles2_callback(NULL, "glGenTextures",
                            (GLADapiproc)glad_glGenTextures, 2, n, textures);
}
...
static void GLAD_API_PTR glad_debug_impl_glGenerateMipmap(GLenum target) {
  _pre_call_gles2_callback("glGenerateMipmap",
                           (GLADapiproc)glad_glGenerateMipmap, 1, target);
  glad_glGenerateMipmap(target);
  _post_call_gles2_callback(NULL, "glGenerateMipmap",
                            (GLADapiproc)glad_glGenerateMipmap, 1, target);
}
...
static void GLAD_API_PTR glad_debug_impl_glGetActiveAttrib(
  ...
  _pre_call_gles2_callback("glGetActiveAttrib",
                           (GLADapiproc)glad_glGetActiveAttrib, 7, program,
                           index, bufSize, length, size, type, name);
  glad_glGetActiveAttrib(program, index, bufSize, length, size, type, name);
  _post_call_gles2_callback(NULL, "glGetActiveAttrib",
                            (GLADapiproc)glad_glGetActiveAttrib, 7, program,
                            index, bufSize, length, size, type, name);
}
...
static void GLAD_API_PTR glad_debug_impl_glGetAttachedShaders(GLuint program,
                                                              ...
                                                              GLsizei *count,
                                                              GLuint *shaders) {
  _pre_call_gles2_callback("glGetAttachedShaders",
  ...
  _post_call_gles2_callback(NULL, "glGetAttachedShaders",
                            (GLADapiproc)glad_glGetAttachedShaders, 4, program,
                            maxCount, count, shaders);
}
...
glad_debug_impl_glGetAttribLocation(GLuint program, const GLchar *name) {
  GLint ret;
  _pre_call_gles2_callback("glGetAttribLocation",
                           (GLADapiproc)glad_glGetAttribLocation, 2, program,
                           name);
  ret = glad_glGetAttribLocation(program, name);
  _post_call_gles2_callback((void *)&ret, "glGetAttribLocation",
                            (GLADapiproc)glad_glGetAttribLocation, 2, program,
                            name);
  return ret;
}
...
static void GLAD_API_PTR glad_debug_impl_glGetBooleanv(GLenum pname,
                                                       GLboolean *data) {
  _pre_call_gles2_callback("glGetBooleanv", (GLADapiproc)glad_glGetBooleanv, 2,
                           pname, data);
  glad_glGetBooleanv(pname, data);
  _post_call_gles2_callback(NULL, "glGetBooleanv",
                            (GLADapiproc)glad_glGetBooleanv, 2, pname, data);
}
...
static void GLAD_API_PTR glad_debug_impl_glGetBufferParameteriv(GLenum target,
                                                                GLenum pname,
                                                                GLint *params) {
  _pre_call_gles2_callback("glGetBufferParameteriv",
                           (GLADapiproc)glad_glGetBufferParameteriv, 3, target,
                           pname, params);
  glad_glGetBufferParameteriv(target, pname, params);
  _post_call_gles2_callback(NULL, "glGetBufferParameteriv",
                            (GLADapiproc)glad_glGetBufferParameteriv, 3, target,
                            pname, params);
}
...
static GLenum GLAD_API_PTR glad_debug_impl_glGetError(void) {
  ...
  ret = glad_glGetError();
  _post_call_gles2_callback((void *)&ret, "glGetError",
...
static void GLAD_API_PTR glad_debug_impl_glGetFloatv(GLenum pname,
                                                     GLfloat *data) {
  _pre_call_gles2_callback("glGetFloatv", (GLADapiproc)glad_glGetFloatv, 2,
                           pname, data);
  glad_glGetFloatv(pname, data);
  _post_call_gles2_callback(NULL, "glGetFloatv", (GLADapiproc)glad_glGetFloatv,
                            2, pname, data);
}
...
static void GLAD_API_PTR glad_debug_impl_glGetIntegerv(GLenum pname,
                                                       GLint *data) {
  _pre_call_gles2_callback("glGetIntegerv", (GLADapiproc)glad_glGetIntegerv, 2,
                           pname, data);
  glad_glGetIntegerv(pname, data);
  _post_call_gles2_callback(NULL, "glGetIntegerv",
                            (GLADapiproc)glad_glGetIntegerv, 2, pname, data);
}
...
static void GLAD_API_PTR glad_debug_impl_glGetProgramInfoLog(GLuint program,
                                                             ...
                                                             GLsizei *length,
                                                             GLchar *infoLog) {
  _pre_call_gles2_callback("glGetProgramInfoLog",
  ...
  _post_call_gles2_callback(NULL, "glGetProgramInfoLog",
                            (GLADapiproc)glad_glGetProgramInfoLog, 4, program,
                            bufSize, length, infoLog);
}
...
static void GLAD_API_PTR glad_debug_impl_glGetProgramiv(GLuint program,
                                                        GLenum pname,
                                                        GLint *params) {
  _pre_call_gles2_callback("glGetProgramiv", (GLADapiproc)glad_glGetProgramiv,
                           3, program, pname, params);
  glad_glGetProgramiv(program, pname, params);
  _post_call_gles2_callback(NULL, "glGetProgramiv",
...
static void GLAD_API_PTR glad_debug_impl_glGetRenderbufferParameteriv(
  ...
  _pre_call_gles2_callback("glGetRenderbufferParameteriv",
                           (GLADapiproc)glad_glGetRenderbufferParameteriv, 3,
                           target, pname, params);
  glad_glGetRenderbufferParameteriv(target, pname, params);
  _post_call_gles2_callback(NULL, "glGetRenderbufferParameteriv",
                            (GLADapiproc)glad_glGetRenderbufferParameteriv, 3,
                            target, pname, params);
}
...
static void GLAD_API_PTR glad_debug_impl_glGetShaderPrecisionFormat(
    GLenum shadertype, GLenum precisiontype, GLint *range, GLint *precision) {
  _pre_call_gles2_callback("glGetShaderPrecisionFormat",
                           (GLADapiproc)glad_glGetShaderPrecisionFormat, 4,
                           shadertype, precisiontype, range, precision);
  glad_glGetShaderPrecisionFormat(shadertype, precisiontype, range, precision);
  _post_call_gles2_callback(NULL, "glGetShaderPrecisionFormat",
                            (GLADapiproc)glad_glGetShaderPrecisionFormat, 4,
                            shadertype, precisiontype, range, precision);
}
...
static void GLAD_API_PTR glad_debug_impl_glGetShaderiv(GLuint shader,
                                                       GLenum pname,
                                                       GLint *params) {
  _pre_call_gles2_callback("glGetShaderiv", (GLADapiproc)glad_glGetShaderiv, 3,
                           shader, pname, params);
  glad_glGetShaderiv(shader, pname, params);
  _post_call_gles2_callback(NULL, "glGetShaderiv",
                            (GLADapiproc)glad_glGetShaderiv, 3, shader, pname,
                            params);
}
...
static const GLubyte *GLAD_API_PTR glad_debug_impl_glGetString(GLenum name) {
  const GLubyte *ret;
  _pre_call_gles2_callback("glGetString", (GLADapiproc)glad_glGetString, 1,
                           name);
  ret = glad_glGetString(name);
  _post_call_gles2_callback((void *)&ret, "glGetString",
...
static void GLAD_API_PTR glad_debug_impl_glGetTexParameterfv(GLenum target,
                                                             GLenum pname,
                                                             GLfloat *params) {
  _pre_call_gles2_callback("glGetTexParameterfv",
                           (GLADapiproc)glad_glGetTexParameterfv, 3, target,
                           pname, params);
  glad_glGetTexParameterfv(target, pname, params);
  _post_call_gles2_callback(NULL, "glGetTexParameterfv",
                            (GLADapiproc)glad_glGetTexParameterfv, 3, target,
                            pname, params);
}
...
static void GLAD_API_PTR glad_debug_impl_glGetTexParameteriv(GLenum target,
                                                             GLenum pname,
                                                             GLint *params) {
  _pre_call_gles2_callback("glGetTexParameteriv",
                           (GLADapiproc)glad_glGetTexParameteriv, 3, target,
                           pname, params);
  glad_glGetTexParameteriv(target, pname, params);
  _post_call_gles2_callback(NULL, "glGetTexParameteriv",
                            (GLADapiproc)glad_glGetTexParameteriv, 3, target,
                            pname, params);
}
...
glad_debug_impl_glGetUniformLocation(GLuint program, const GLchar *name) {
  GLint ret;
  _pre_call_gles2_callback("glGetUniformLocation",
                           (GLADapiproc)glad_glGetUniformLocation, 2, program,
                           name);
  ret = glad_glGetUniformLocation(program, name);
  _post_call_gles2_callback((void *)&ret, "glGetUniformLocation",
                            (GLADapiproc)glad_glGetUniformLocation, 2, program,
                            name);
  return ret;
}
...
static void GLAD_API_PTR glad_debug_impl_glGetUniformfv(GLuint program,
                                                        GLint location,
                                                        GLfloat *params) {
  _pre_call_gles2_callback("glGetUniformfv", (GLADapiproc)glad_glGetUniformfv,
                           3, program, location, params);
  glad_glGetUniformfv(program, location, params);
  _post_call_gles2_callback(NULL, "glGetUniformfv",
                            (GLADapiproc)glad_glGetUniformfv, 3, program,
                            location, params);
}
...
static void GLAD_API_PTR glad_debug_impl_glGetUniformiv(GLuint program,
                                                        GLint location,
                                                        GLint *params) {
  _pre_call_gles2_callback("glGetUniformiv", (GLADapiproc)glad_glGetUniformiv,
                           3, program, location, params);
  glad_glGetUniformiv(program, location, params);
  _post_call_gles2_callback(NULL, "glGetUniformiv",
                            (GLADapiproc)glad_glGetUniformiv, 3, program,
                            location, params);
}
...
static void GLAD_API_PTR glad_debug_impl_glGetVertexAttribPointerv(
  ...
  _pre_call_gles2_callback("glGetVertexAttribPointerv",
                           (GLADapiproc)glad_glGetVertexAttribPointerv, 3,
                           index, pname, pointer);
  glad_glGetVertexAttribPointerv(index, pname, pointer);
  _post_call_gles2_callback(NULL, "glGetVertexAttribPointerv",
                            (GLADapiproc)glad_glGetVertexAttribPointerv, 3,
                            index, pname, pointer);
}
...
static void GLAD_API_PTR glad_debug_impl_glGetVertexAttribfv(GLuint index,
                                                             GLenum pname,
                                                             GLfloat *params) {
  _pre_call_gles2_callback("glGetVertexAttribfv",
                           (GLADapiproc)glad_glGetVertexAttribfv, 3, index,
                           pname, params);
  glad_glGetVertexAttribfv(index, pname, params);
  _post_call_gles2_callback(NULL, "glGetVertexAttribfv",
                            (GLADapiproc)glad_glGetVertexAttribfv, 3, index,
                            pname, params);
}
...
static void GLAD_API_PTR glad_debug_impl_glGetVertexAttribiv(GLuint index,
                                                             GLenum pname,
                                                             GLint *params) {
  _pre_call_gles2_callback("glGetVertexAttribiv",
                           (GLADapiproc)glad_glGetVertexAttribiv, 3, index,
                           pname, params);
  glad_glGetVertexAttribiv(index, pname, params);
  _post_call_gles2_callback(NULL, "glGetVertexAttribiv",
                            (GLADapiproc)glad_glGetVertexAttribiv, 3, index,
                            pname, params);
}
...
static void GLAD_API_PTR glad_debug_impl_glHint(GLenum target, GLenum mode) {
  ...
  _post_call_gles2_callback(NULL, "glHint", (GLADapiproc)glad_glHint, 2, target,
                            mode);
}
...
static GLboolean GLAD_API_PTR glad_debug_impl_glIsBuffer(GLuint buffer) {
  GLboolean ret;
  _pre_call_gles2_callback("glIsBuffer", (GLADapiproc)glad_glIsBuffer, 1,
                           buffer);
  ret = glad_glIsBuffer(buffer);
  _post_call_gles2_callback((void *)&ret, "glIsBuffer",
...
static GLboolean GLAD_API_PTR glad_debug_impl_glIsEnabled(GLenum cap) {
  GLboolean ret;
  _pre_call_gles2_callback("glIsEnabled", (GLADapiproc)glad_glIsEnabled, 1,
                           cap);
  ret = glad_glIsEnabled(cap);
  _post_call_gles2_callback((void *)&ret, "glIsEnabled",
...
glad_debug_impl_glIsFramebuffer(GLuint framebuffer) {
  GLboolean ret;
  _pre_call_gles2_callback("glIsFramebuffer", (GLADapiproc)glad_glIsFramebuffer,
                           1, framebuffer);
  ret = glad_glIsFramebuffer(framebuffer);
  _post_call_gles2_callback((void *)&ret, "glIsFramebuffer",
...
static GLboolean GLAD_API_PTR glad_debug_impl_glIsProgram(GLuint program) {
  GLboolean ret;
  _pre_call_gles2_callback("glIsProgram", (GLADapiproc)glad_glIsProgram, 1,
                           program);
  ret = glad_glIsProgram(program);
  _post_call_gles2_callback((void *)&ret, "glIsProgram",
...
glad_debug_impl_glIsRenderbuffer(GLuint renderbuffer) {
  GLboolean ret;
  _pre_call_gles2_callback("glIsRenderbuffer",
                           (GLADapiproc)glad_glIsRenderbuffer, 1, renderbuffer);
  ret = glad_glIsRenderbuffer(renderbuffer);
  _post_call_gles2_callback((void *)&ret, "glIsRenderbuffer",
                            (GLADapiproc)glad_glIsRenderbuffer, 1,
                            renderbuffer);
  return ret;
}
...
static GLboolean GLAD_API_PTR glad_debug_impl_glIsShader(GLuint shader) {
  GLboolean ret;
  _pre_call_gles2_callback("glIsShader", (GLADapiproc)glad_glIsShader, 1,
                           shader);
  ret = glad_glIsShader(shader);
  _post_call_gles2_callback((void *)&ret, "glIsShader",
...
static GLboolean GLAD_API_PTR glad_debug_impl_glIsTexture(GLuint texture) {
  GLboolean ret;
  _pre_call_gles2_callback("glIsTexture", (GLADapiproc)glad_glIsTexture, 1,
                           texture);
  ret = glad_glIsTexture(texture);
  _post_call_gles2_callback((void *)&ret, "glIsTexture",
...
static void GLAD_API_PTR glad_debug_impl_glLineWidth(GLfloat width) {
  _pre_call_gles2_callback("glLineWidth", (GLADapiproc)glad_glLineWidth, 1,
                           width);
  glad_glLineWidth(width);
  _post_call_gles2_callback(NULL, "glLineWidth", (GLADapiproc)glad_glLineWidth,
                            1, width);
}
...
static void GLAD_API_PTR glad_debug_impl_glLinkProgram(GLuint program) {
  _pre_call_gles2_callback("glLinkProgram", (GLADapiproc)glad_glLinkProgram, 1,
                           program);
  glad_glLinkProgram(program);
  _post_call_gles2_callback(NULL, "glLinkProgram",
                            (GLADapiproc)glad_glLinkProgram, 1, program);
}
...
static void GLAD_API_PTR glad_debug_impl_glPixelStorei(GLenum pname,
                                                       GLint param) {
  _pre_call_gles2_callback("glPixelStorei", (GLADapiproc)glad_glPixelStorei, 2,
                           pname, param);
  glad_glPixelStorei(pname, param);
  _post_call_gles2_callback(NULL, "glPixelStorei",
                            (GLADapiproc)glad_glPixelStorei, 2, pname, param);
}
...
static void GLAD_API_PTR glad_debug_impl_glPolygonOffset(GLfloat factor,
                                                         GLfloat units) {
  _pre_call_gles2_callback("glPolygonOffset", (GLADapiproc)glad_glPolygonOffset,
                           2, factor, units);
  glad_glPolygonOffset(factor, units);
  _post_call_gles2_callback(NULL, "glPolygonOffset",
                            (GLADapiproc)glad_glPolygonOffset, 2, factor,
                            units);
}
...
glad_debug_impl_glReadPixels(GLint x, GLint y, GLsizei width, GLsizei height,
  ...
  _pre_call_gles2_callback("glReadPixels", (GLADapiproc)glad_glReadPixels, 7, x,
                           y, width, height, format, type, pixels);
  glad_glReadPixels(x, y, width, height, format, type, pixels);
  _post_call_gles2_callback(NULL, "glReadPixels",
                            (GLADapiproc)glad_glReadPixels, 7, x, y, width,
...
static void GLAD_API_PTR glad_debug_impl_glReleaseShaderCompiler(void) {
  _pre_call_gles2_callback("glReleaseShaderCompiler",
                           (GLADapiproc)glad_glReleaseShaderCompiler, 0);
  glad_glReleaseShaderCompiler();
  _post_call_gles2_callback(NULL, "glReleaseShaderCompiler",
                            (GLADapiproc)glad_glReleaseShaderCompiler, 0);
}
...
static void GLAD_API_PTR glad_debug_impl_glSampleCoverage(GLfloat value,
                                                          GLboolean invert) {
  _pre_call_gles2_callback(
      "glSampleCoverage", (GLADapiproc)glad_glSampleCoverage, 2, value, invert);
  glad_glSampleCoverage(value, invert);
  _post_call_gles2_callback(NULL, "glSampleCoverage",
                            (GLADapiproc)glad_glSampleCoverage, 2, value,
                            invert);
}
...
static void GLAD_API_PTR glad_debug_impl_glScissor(GLint x, GLint y,
                                                   GLsizei width,
                                                   GLsizei height) {
  _pre_call_gles2_callback("glScissor", (GLADapiproc)glad_glScissor, 4, x, y,
                           width, height);
  glad_glScissor(x, y, width, height);
  _post_call_gles2_callback(NULL, "glScissor", (GLADapiproc)glad_glScissor, 4,
                            x, y, width, height);
}
PFNGLSCISSORPROC glad_debug_glScissor = glad_debug_impl_glScissor;
PFNGLSHADERBINARYPROC glad_glShaderBinary = NULL;
static void GLAD_API_PTR glad_debug_impl_glShaderBinary(GLsizei count,
                                                        const GLuint *shaders,
                                                        GLenum binaryFormat,
                                                        const void *binary,
                                                        GLsizei length) {
  _pre_call_gles2_callback("glShaderBinary", (GLADapiproc)glad_glShaderBinary,
                           5, count, shaders, binaryFormat, binary, length);
  glad_glShaderBinary(count, shaders, binaryFormat, binary, length);
  _post_call_gles2_callback(NULL, "glShaderBinary",
                            (GLADapiproc)glad_glShaderBinary, 5, count, shaders,
...
static void GLAD_API_PTR glad_debug_impl_glShaderSource(
    ...
    const GLint *length) {
  _pre_call_gles2_callback("glShaderSource", (GLADapiproc)glad_glShaderSource,
                           4, shader, count, string, length);
  glad_glShaderSource(shader, count, string, length);
  _post_call_gles2_callback(NULL, "glShaderSource",
...
static void GLAD_API_PTR glad_debug_impl_glStencilFunc(GLenum func, GLint ref,
                                                       GLuint mask) {
  _pre_call_gles2_callback("glStencilFunc", (GLADapiproc)glad_glStencilFunc, 3,
                           func, ref, mask);
  glad_glStencilFunc(func, ref, mask);
  _post_call_gles2_callback(NULL, "glStencilFunc",
                            (GLADapiproc)glad_glStencilFunc, 3, func, ref,
                            mask);
}
...
static void GLAD_API_PTR glad_debug_impl_glStencilFuncSeparate(GLenum face,
                                                               ...
                                                               GLint ref,
                                                               GLuint mask) {
  _pre_call_gles2_callback("glStencilFuncSeparate",
                           (GLADapiproc)glad_glStencilFuncSeparate, 4, face,
                           func, ref, mask);
  glad_glStencilFuncSeparate(face, func, ref, mask);
  _post_call_gles2_callback(NULL, "glStencilFuncSeparate",
                            (GLADapiproc)glad_glStencilFuncSeparate, 4, face,
                            func, ref, mask);
}
...
static void GLAD_API_PTR glad_debug_impl_glStencilMask(GLuint mask) {
  _pre_call_gles2_callback("glStencilMask", (GLADapiproc)glad_glStencilMask, 1,
                           mask);
  glad_glStencilMask(mask);
  _post_call_gles2_callback(NULL, "glStencilMask",
                            (GLADapiproc)glad_glStencilMask, 1, mask);
}
...
static void GLAD_API_PTR glad_debug_impl_glStencilMaskSeparate(GLenum face,
                                                               GLuint mask) {
  _pre_call_gles2_callback("glStencilMaskSeparate",
                           (GLADapiproc)glad_glStencilMaskSeparate, 2, face,
                           mask);
  glad_glStencilMaskSeparate(face, mask);
  _post_call_gles2_callback(NULL, "glStencilMaskSeparate",
                            (GLADapiproc)glad_glStencilMaskSeparate, 2, face,
                            mask);
}
...
static void GLAD_API_PTR glad_debug_impl_glStencilOp(GLenum fail, GLenum zfail,
                                                     GLenum zpass) {
  _pre_call_gles2_callback("glStencilOp", (GLADapiproc)glad_glStencilOp, 3,
                           fail, zfail, zpass);
  glad_glStencilOp(fail, zfail, zpass);
  _post_call_gles2_callback(NULL, "glStencilOp", (GLADapiproc)glad_glStencilOp,
                            3, fail, zfail, zpass);
}
...
static void GLAD_API_PTR glad_debug_impl_glStencilOpSeparate(GLenum face,
                                                             ...
                                                             GLenum dpfail,
                                                             GLenum dppass) {
  _pre_call_gles2_callback("glStencilOpSeparate",
                           (GLADapiproc)glad_glStencilOpSeparate, 4, face,
                           sfail, dpfail, dppass);
  glad_glStencilOpSeparate(face, sfail, dpfail, dppass);
  _post_call_gles2_callback(NULL, "glStencilOpSeparate",
                            (GLADapiproc)glad_glStencilOpSeparate, 4, face,
                            sfail, dpfail, dppass);
}
...
glad_debug_impl_glTexImage2D(GLenum target, GLint level, GLint internalformat,
  ...
  _pre_call_gles2_callback("glTexImage2D", (GLADapiproc)glad_glTexImage2D, 9,
                           target, level, internalformat, width, height, border,
                           format, type, pixels);
  glad_glTexImage2D(target, level, internalformat, width, height, border,
                    format, type, pixels);
  _post_call_gles2_callback(
      NULL, "glTexImage2D", (GLADapiproc)glad_glTexImage2D, 9, target, level,
...
static void GLAD_API_PTR glad_debug_impl_glTexParameterf(GLenum target,
                                                         GLenum pname,
                                                         GLfloat param) {
  _pre_call_gles2_callback("glTexParameterf", (GLADapiproc)glad_glTexParameterf,
                           3, target, pname, param);
  glad_glTexParameterf(target, pname, param);
  _post_call_gles2_callback(NULL, "glTexParameterf",
...
static void GLAD_API_PTR glad_debug_impl_glTexParameterfv(
  ...
  _pre_call_gles2_callback("glTexParameterfv",
                           (GLADapiproc)glad_glTexParameterfv, 3, target, pname,
                           params);
  glad_glTexParameterfv(target, pname, params);
  _post_call_gles2_callback(NULL, "glTexParameterfv",
                            (GLADapiproc)glad_glTexParameterfv, 3, target,
                            pname, params);
}
...
static void GLAD_API_PTR glad_debug_impl_glTexParameteri(GLenum target,
                                                         GLenum pname,
                                                         GLint param) {
  _pre_call_gles2_callback("glTexParameteri", (GLADapiproc)glad_glTexParameteri,
                           3, target, pname, param);
  glad_glTexParameteri(target, pname, param);
  _post_call_gles2_callback(NULL, "glTexParameteri",
...
static void GLAD_API_PTR glad_debug_impl_glTexSubImage2D(
  ...
  _pre_call_gles2_callback("glTexSubImage2D", (GLADapiproc)glad_glTexSubImage2D,
                           9, target, level, xoffset, yoffset, width, height,
                           format, type, pixels);
  glad_glTexSubImage2D(target, level, xoffset, yoffset, width, height, format,
                       type, pixels);
  _post_call_gles2_callback(
      NULL, "glTexSubImage2D", (GLADapiproc)glad_glTexSubImage2D, 9, target,
...
static void GLAD_API_PTR glad_debug_impl_glUniform1f(GLint location,
                                                     GLfloat v0) {
  _pre_call_gles2_callback("glUniform1f", (GLADapiproc)glad_glUniform1f, 2,
                           location, v0);
  glad_glUniform1f(location, v0);
  _post_call_gles2_callback(NULL, "glUniform1f", (GLADapiproc)glad_glUniform1f,
                            2, location, v0);
}
...
static void GLAD_API_PTR glad_debug_impl_glUniform1fv(GLint location,
                                                      GLsizei count,
                                                      const GLfloat *value) {
  _pre_call_gles2_callback("glUniform1fv", (GLADapiproc)glad_glUniform1fv, 3,
                           location, count, value);
  glad_glUniform1fv(location, count, value);
  _post_call_gles2_callback(NULL, "glUniform1fv",
                            (GLADapiproc)glad_glUniform1fv, 3, location, count,
                            value);
}
...
static void GLAD_API_PTR glad_debug_impl_glUniform1i(GLint location, GLint v0) {
  _pre_call_gles2_callback("glUniform1i", (GLADapiproc)glad_glUniform1i, 2,
                           location, v0);
  glad_glUniform1i(location, v0);
  _post_call_gles2_callback(NULL, "glUniform1i", (GLADapiproc)glad_glUniform1i,
                            2, location, v0);
}
...
static void GLAD_API_PTR glad_debug_impl_glUniform1iv(GLint location,
                                                      GLsizei count,
                                                      const GLint *value) {
  _pre_call_gles2_callback("glUniform1iv", (GLADapiproc)glad_glUniform1iv, 3,
                           location, count, value);
  glad_glUniform1iv(location, count, value);
  _post_call_gles2_callback(NULL, "glUniform1iv",
                            (GLADapiproc)glad_glUniform1iv, 3, location, count,
                            value);
}
...
static void GLAD_API_PTR glad_debug_impl_glUniform2f(GLint location, GLfloat v0,
                                                     GLfloat v1) {
  _pre_call_gles2_callback("glUniform2f", (GLADapiproc)glad_glUniform2f, 3,
                           location, v0, v1);
  glad_glUniform2f(location, v0, v1);
  _post_call_gles2_callback(NULL, "glUniform2f", (GLADapiproc)glad_glUniform2f,
                            3, location, v0, v1);
}
...
static void GLAD_API_PTR glad_debug_impl_glUniform2fv(GLint location,
                                                      GLsizei count,
                                                      const GLfloat *value) {
  _pre_call_gles2_callback("glUniform2fv", (GLADapiproc)glad_glUniform2fv, 3,
                           location, count, value);
  glad_glUniform2fv(location, count, value);
  _post_call_gles2_callback(NULL, "glUniform2fv",
                            (GLADapiproc)glad_glUniform2fv, 3, location, count,
                            value);
}
...
static void GLAD_API_PTR glad_debug_impl_glUniform2i(GLint location, GLint v0,
                                                     GLint v1) {
  _pre_call_gles2_callback("glUniform2i", (GLADapiproc)glad_glUniform2i, 3,
                           location, v0, v1);
  glad_glUniform2i(location, v0, v1);
  _post_call_gles2_callback(NULL, "glUniform2i", (GLADapiproc)glad_glUniform2i,
                            3, location, v0, v1);
}
...
static void GLAD_API_PTR glad_debug_impl_glUniform2iv(GLint location,
                                                      GLsizei count,
                                                      const GLint *value) {
  _pre_call_gles2_callback("glUniform2iv", (GLADapiproc)glad_glUniform2iv, 3,
                           location, count, value);
  glad_glUniform2iv(location, count, value);
  _post_call_gles2_callback(NULL, "glUniform2iv",
                            (GLADapiproc)glad_glUniform2iv, 3, location, count,
                            value);
}
...
static void GLAD_API_PTR glad_debug_impl_glUniform3f(GLint location, GLfloat v0,
  ...
  _pre_call_gles2_callback("glUniform3f", (GLADapiproc)glad_glUniform3f, 4,
                           location, v0, v1, v2);
  glad_glUniform3f(location, v0, v1, v2);
  _post_call_gles2_callback(NULL, "glUniform3f", (GLADapiproc)glad_glUniform3f,
                            4, location, v0, v1, v2);
}
...
static void GLAD_API_PTR glad_debug_impl_glUniform3fv(GLint location,
                                                      GLsizei count,
                                                      const GLfloat *value) {
  _pre_call_gles2_callback("glUniform3fv", (GLADapiproc)glad_glUniform3fv, 3,
                           location, count, value);
  glad_glUniform3fv(location, count, value);
  _post_call_gles2_callback(NULL, "glUniform3fv",
                            (GLADapiproc)glad_glUniform3fv, 3, location, count,
                            value);
}
...
static void GLAD_API_PTR glad_debug_impl_glUniform3i(GLint location, GLint v0,
                                                     GLint v1, GLint v2) {
  _pre_call_gles2_callback("glUniform3i", (GLADapiproc)glad_glUniform3i, 4,
                           location, v0, v1, v2);
  glad_glUniform3i(location, v0, v1, v2);
  _post_call_gles2_callback(NULL, "glUniform3i", (GLADapiproc)glad_glUniform3i,
                            4, location, v0, v1, v2);
}
...
static void GLAD_API_PTR glad_debug_impl_glUniform3iv(GLint location,
                                                      GLsizei count,
                                                      const GLint *value) {
  _pre_call_gles2_callback("glUniform3iv", (GLADapiproc)glad_glUniform3iv, 3,
                           location, count, value);
  glad_glUniform3iv(location, count, value);
  _post_call_gles2_callback(NULL, "glUniform3iv",
                            (GLADapiproc)glad_glUniform3iv, 3, location, count,
                            value);
}
...
static void GLAD_API_PTR glad_debug_impl_glUniform4f(GLint location, GLfloat v0,
                                                     GLfloat v1, GLfloat v2,
                                                     GLfloat v3) {
  _pre_call_gles2_callback("glUniform4f", (GLADapiproc)glad_glUniform4f, 5,
                           location, v0, v1, v2, v3);
  glad_glUniform4f(location, v0, v1, v2, v3);
  _post_call_gles2_callback(NULL, "glUniform4f", (GLADapiproc)glad_glUniform4f,
...
static void GLAD_API_PTR glad_debug_impl_glUniform4fv(GLint location,
                                                      GLsizei count,
                                                      const GLfloat *value) {
  _pre_call_gles2_callback("glUniform4fv", (GLADapiproc)glad_glUniform4fv, 3,
                           location, count, value);
  glad_glUniform4fv(location, count, value);
  _post_call_gles2_callback(NULL, "glUniform4fv",
                            (GLADapiproc)glad_glUniform4fv, 3, location, count,
                            value);
}
...
static void GLAD_API_PTR glad_debug_impl_glUniform4i(GLint location, GLint v0,
                                                     GLint v1, GLint v2,
                                                     GLint v3) {
  _pre_call_gles2_callback("glUniform4i", (GLADapiproc)glad_glUniform4i, 5,
                           location, v0, v1, v2, v3);
  glad_glUniform4i(location, v0, v1, v2, v3);
  _post_call_gles2_callback(NULL, "glUniform4i", (GLADapiproc)glad_glUniform4i,
                            5, location, v0, v1, v2, v3);
}
...
static void GLAD_API_PTR glad_debug_impl_glUniform4iv(GLint location,
                                                      GLsizei count,
                                                      const GLint *value) {
  _pre_call_gles2_callback("glUniform4iv", (GLADapiproc)glad_glUniform4iv, 3,
                           location, count, value);
  glad_glUniform4iv(location, count, value);
  _post_call_gles2_callback(NULL, "glUniform4iv",
                            (GLADapiproc)glad_glUniform4iv, 3, location, count,
                            value);
}
...
static void GLAD_API_PTR glad_debug_impl_glUseProgram(GLuint program) {
  _pre_call_gles2_callback("glUseProgram", (GLADapiproc)glad_glUseProgram, 1,
                           program);
  glad_glUseProgram(program);
  _post_call_gles2_callback(NULL, "glUseProgram",
                            (GLADapiproc)glad_glUseProgram, 1, program);
}
...
static void GLAD_API_PTR glad_debug_impl_glValidateProgram(GLuint program) {
  _pre_call_gles2_callback("glValidateProgram",
                           (GLADapiproc)glad_glValidateProgram, 1, program);
  glad_glValidateProgram(program);
  _post_call_gles2_callback(NULL, "glValidateProgram",
                            (GLADapiproc)glad_glValidateProgram, 1, program);
}
...
static void GLAD_API_PTR glad_debug_impl_glVertexAttrib1f(GLuint index,
                                                          GLfloat x) {
  _pre_call_gles2_callback("glVertexAttrib1f",
                           (GLADapiproc)glad_glVertexAttrib1f, 2, index, x);
  glad_glVertexAttrib1f(index, x);
  _post_call_gles2_callback(NULL, "glVertexAttrib1f",
                            (GLADapiproc)glad_glVertexAttrib1f, 2, index, x);
}
...
static void GLAD_API_PTR glad_debug_impl_glVertexAttrib1fv(GLuint index,
                                                           const GLfloat *v) {
  _pre_call_gles2_callback("glVertexAttrib1fv",
                           (GLADapiproc)glad_glVertexAttrib1fv, 2, index, v);
  glad_glVertexAttrib1fv(index, v);
  _post_call_gles2_callback(NULL, "glVertexAttrib1fv",
                            (GLADapiproc)glad_glVertexAttrib1fv, 2, index, v);
}
...
static void GLAD_API_PTR glad_debug_impl_glVertexAttrib2f(GLuint index,
                                                          GLfloat x,
                                                          GLfloat y) {
  _pre_call_gles2_callback("glVertexAttrib2f",
                           (GLADapiproc)glad_glVertexAttrib2f, 3, index, x, y);
  glad_glVertexAttrib2f(index, x, y);
  _post_call_gles2_callback(NULL, "glVertexAttrib2f",
                            (GLADapiproc)glad_glVertexAttrib2f, 3, index, x, y);
}
...
static void GLAD_API_PTR glad_debug_impl_glVertexAttrib2fv(GLuint index,
                                                           const GLfloat *v) {
  _pre_call_gles2_callback("glVertexAttrib2fv",
                           (GLADapiproc)glad_glVertexAttrib2fv, 2, index, v);
  glad_glVertexAttrib2fv(index, v);
  _post_call_gles2_callback(NULL, "glVertexAttrib2fv",
                            (GLADapiproc)glad_glVertexAttrib2fv, 2, index, v);
}
...
static void GLAD_API_PTR glad_debug_impl_glVertexAttrib3f(GLuint index,
                                                          GLfloat x, GLfloat y,
                                                          GLfloat z) {
  _pre_call_gles2_callback("glVertexAttrib3f",
                           (GLADapiproc)glad_glVertexAttrib3f, 4, index, x, y,
                           z);
  glad_glVertexAttrib3f(index, x, y, z);
  _post_call_gles2_callback(NULL, "glVertexAttrib3f",
                            (GLADapiproc)glad_glVertexAttrib3f, 4, index, x, y,
                            z);
}
...
static void GLAD_API_PTR glad_debug_impl_glVertexAttrib3fv(GLuint index,
                                                           const GLfloat *v) {
  _pre_call_gles2_callback("glVertexAttrib3fv",
                           (GLADapiproc)glad_glVertexAttrib3fv, 2, index, v);
  glad_glVertexAttrib3fv(index, v);
  _post_call_gles2_callback(NULL, "glVertexAttrib3fv",
                            (GLADapiproc)glad_glVertexAttrib3fv, 2, index, v);
}
...
static void GLAD_API_PTR glad_debug_impl_glVertexAttrib4f(GLuint index,
                                                          ...
                                                          GLfloat z,
                                                          GLfloat w) {
  _pre_call_gles2_callback("glVertexAttrib4f",
                           (GLADapiproc)glad_glVertexAttrib4f, 5, index, x, y,
                           z, w);
  glad_glVertexAttrib4f(index, x, y, z, w);
  _post_call_gles2_callback(NULL, "glVertexAttrib4f",
                            (GLADapiproc)glad_glVertexAttrib4f, 5, index, x, y,
                            z, w);
}
...
static void GLAD_API_PTR glad_debug_impl_glVertexAttrib4fv(GLuint index,
                                                           const GLfloat *v) {
  _pre_call_gles2_callback("glVertexAttrib4fv",
                           (GLADapiproc)glad_glVertexAttrib4fv, 2, index, v);
  glad_glVertexAttrib4fv(index, v);
  _post_call_gles2_callback(NULL, "glVertexAttrib4fv",
                            (GLADapiproc)glad_glVertexAttrib4fv, 2, index, v);
}
...
static void GLAD_API_PTR glad_debug_impl_glVertexAttribPointer(
    ...
    const void *pointer) {
  _pre_call_gles2_callback("glVertexAttribPointer",
  ...
  _post_call_gles2_callback(NULL, "glVertexAttribPointer",
                            (GLADapiproc)glad_glVertexAttribPointer, 6, index,
                            size, type, normalized, stride, pointer);
}
...
static void GLAD_API_PTR glad_debug_impl_glViewport(GLint x, GLint y,
                                                    GLsizei width,
                                                    GLsizei height) {
  _pre_call_gles2_callback("glViewport", (GLADapiproc)glad_glViewport, 4, x, y,
                           width, height);
  glad_glViewport(x, y, width, height);
  _post_call_gles2_callback(NULL, "glViewport", (GLADapiproc)glad_glViewport, 4,
                            x, y, width, height);
}
...
typedef __eglMustCastToProperFunctionPointerType(
    GLAD_API_PTR *PFNEGLGETPROCADDRESSPROC)(const char *name);
#endif
extern __eglMustCastToProperFunctionPointerType
emscripten_GetProcAddress(const char *name);
